...
{
	int32_t value, fc1_offset, fc2_offset, run_out_offset, ctr = 0;
	rsx_dev_core_obj_t *core = NULL;
...
{
	int32_t ret = -1, fc1_offset, fc2_offset, ctr = 0;
	rsx_dev_core_obj_t *core = NULL;
	...
	// map DMA memory
	ret = rsx_map_io_to_lpar((int32_t)core->core_id,       // (IN) device core ID, 2
