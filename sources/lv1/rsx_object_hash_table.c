...
* int32_t channel_id           = channel ID of RSX context, 0 to 3(max)
* uint32_t class_type          = type of class object, sw, hv or dma
*                                sw  e.g. 0xCAFEBABE
...
void rsx_object_hash_table_create_entry(rsx_hash_tbl_obj_t *hash_tbl, int32_t channel_id, uint32_t class_type, int32_t offset, int32_t arg1)
{
	...
	int32_t value, max_channels, entry_offset = 0;
...
void rsx_object_hash_table_init(rsx_hash_tbl_obj_t *hash_tbl)
{
	...
	hash_tbl->bar0_offset = rsx_core_memory_get_BAR2_offset_by_address((void*)core->core_mem_obj, hash_tbl->io_addr);
