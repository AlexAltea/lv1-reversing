...
* 
***********************************************************************/
int32_t rsx_object_video_rsx_223230(rsx_obj_video_rsx_t *video_rsx, int32_t id, int32_t arg2)
{
...
* 
***********************************************************************/
void rsx_object_video_rsx_222F2C(rsx_obj_video_rsx_t *video_rsx, int32_t arg1)
{
...
* 
***********************************************************************/
int32_t rsx_object_video_rsx_2231BC(rsx_obj_video_rsx_t *video_rsx, int32_t idx)
{
	if(idx > 3)
	{
...
* 
***********************************************************************/
int32_t rsx_object_video_rsx_223510(rsx_obj_video_rsx_t *video_rsx, int32_t id, int32_t arg2)
{
	int32_t i, value1, value2, offset;
...
{
	int32_t i, value, offset = 0;
	uint64_t rsx_debug = 0;
