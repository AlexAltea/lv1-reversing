...
{
	int64_t io_addr = 0, lpar_size = 0;
	int32_t ret = -1, io_size = 0;
...
* 
***********************************************************************/
int32_t rsx_core_device_get_rsx_enable_flag()
{
...
* 
***********************************************************************/
static void rsx_core_device_init(rsx_dev_core_obj_t *dev_core, int32_t arg1, int32_t dev_core_id)
{
	int32_t i;
