...
#define     RSX_PFIFO_INTR_CACHE_ERROR                       (1 <<  0)
#define     RSX_PFIFO_INTR_RUNOUT                            (1 <<  4)
#define     RSX_PFIFO_INTR_RUNOUT_OVERFLOW                   (1 <<  8)
#define     RSX_PFIFO_INTR_DMA_PUSHER                        (1 << 12)
#define     RSX_PFIFO_INTR_DMA_PT                            (1 << 16)
#define     RSX_PFIFO_INTR_BIT18                             (1 << 18)
#define     RSX_PFIFO_INTR_BIT19                             (1 << 19)
#define     RSX_PFIFO_INTR_SEMAPHORE                         (1 << 20)
#define     RSX_PFIFO_INTR_BIT21                             (1 << 21)
#define     RSX_PFIFO_INTR_BIT22                             (1 << 22)
#define     RSX_PFIFO_INTR_ACQUIRE_TIMEOUT                   (1 << 24)
...
#define RSX_PFIFO_UNK2510                                 0x00002510
#define RSX_PFIFO_CACHE1_PUSH0                            0x00003200
#define RSX_PFIFO_CACHE1_PUSH1                            0x00003204
...
#define RSX_PFB_UNK032C                (0x0010032C)
#define RSX_PFB_UNK0330                (0x00100330)
#define RSX_PFB_UNK0334                (0x00100334)
#define RSX_PFB_UNK0338                (0x00100338)
#define RSX_PFB_CLOSE_PAGE2            (0x0010033C)
#define RSX_PFB_UNK0340                (0x00100340)
#define RSX_PFB_UNK0344                (0x00100344)
#define RSX_PFB_UNK0348                (0x00100348)
#define RSX_PFB_UNK0350                (0x00100350)
#define RSX_PFB_UNK0354                (0x00100354)
...
#define     RSX_PGRAPH_NSOURCE_LIMIT_COLOR             (1 <<  4)  // Color limit error pending
#define     RSX_PGRAPH_NSOURCE_LIMIT_ZETA              (1 <<  5)  // Zeta limit error pending
...
#define     RSX_PGRAPH_NSOURCE_BFR_NOTIFICATION        (1 << 15)  // Bfr notification error pending
