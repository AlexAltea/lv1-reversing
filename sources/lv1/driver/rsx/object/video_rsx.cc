...
***********************************************************************/
void rsx_object_video_rsx_2245F4(rsx_object_video_rsx_t* video_rsx) {
...
* 
***********************************************************************/
S32 rsx_object_video_rsx_223230(rsx_object_video_rsx_t* video_rsx, S32 id, S32 arg2) {
    S32 offset, value;
    ...
    if (id <= 1)  // valid id, 0 or 1 {
        ...
        // set BAR0 registers
        value = rsx_rd32(offset + 0x28000600810);
        value |= 1;                                 // set value[31:31]
        rsx_wr32(value, offset + 0x28000600810);
        ...
        rsx_wr32(arg2, offset + 0x2800060080C);   
        
        value = video_rsx->unk_84[id];
        rsx_wr32(value, offset + 0x28000680300);
...
* 
***********************************************************************/
void rsx_object_video_rsx_222F2C(rsx_object_video_rsx_t* video_rsx, S32 arg1) {
    S32 value, offset = 0;
    ...
    value = rsx_rd32(offset + 0x2800008C004);
  value &= 0x7FFFFFFF;                          // unset value[00:00]
  rsx_wr32(value, offset + 0x2800008C004);
  ...
  rsx_wr32(value, offset + 0x2800008C008);
  
  value = rsx_rd32(offset + 0x2800008C00C);
  value = 0xA;                                  // set value[28:28] and value[31:31], old value lost
  rsx_wr32(value, offset + 0x2800008C00C);
...
* 
***********************************************************************/
S32 rsx_object_video_rsx_2231BC(rsx_object_video_rsx_t* video_rsx, S32 idx) {
    if (idx > 3) {
...
* 
***********************************************************************/
S32 rsx_object_video_rsx_223510(rsx_object_video_rsx_t* video_rsx, S32 id, S32 arg2) {
  ...
  // ?
    ...
    value1 = rsx_rd32(offset + 0x2800008C000);
    value1 |= 1;                                      // set value[31:31]
    rsx_wr32(value1, offset + 0x2800008C000);
    
    
    // ?
    offset = (rsx_object_video_rsx_2231BC(video_rsx, id)) <<13;
    value1 = rsx_rd32(offset + 0x28000680804);
    value1 &= 0xFFFF;                                 // unset value[00:15]
    
    offset = (rsx_object_video_rsx_2231BC(video_rsx, id)) <<13;
    value2 = rsx_rd32(offset + 0x2800068080C);
...
* 
***********************************************************************/
void rsx_object_video_rsx_init(rsx_object_video_rsx_t* video_rsx) {
  ...
  for (i = 0; i < 2; i++) {
        ...
        value = rsx_rd32(offset + 0x2800008C000);
        value |= 1;                               // set value[31:31]
        rsx_wr32(value, offset + 0x2800008C000);
  ...
  for (i = 0; i < 2; i++)
    ...
    for (i = 0; i < 2; i++) {
      ...
      value = rsx_rd32(offset + 0x28000680404);
      value &= 0x7FFFFFFF;                        // unset value[00:00]
      rsx_wr32(value, offset + 0x28000680404);
    }
